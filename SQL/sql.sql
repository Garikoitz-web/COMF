...
create table xd (`token` varchar(255) COLLATE utf8_unicode_ci NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

insert into xd (token) values ('ªº·');
...
MariaDB [comf]> select instrumento, afinacion, I_MAYOR, II_menor, III_menor, IV_MAYOR, V_MAYOR, VI_menor, VII_disminuido from escalas where tonalidad='B';
+-------------+-----------+---------+----------+-----------+----------+---------+----------+----------------+
| instrumento | afinacion | I_MAYOR | II_menor | III_menor | IV_MAYOR | V_MAYOR | VI_menor | VII_disminuido |
+-------------+-----------+---------+----------+-----------+----------+---------+----------+----------------+
| Guitarra    | EADGBE    | B       | C#m/Dbm  | E         | E        | F#/Gb   | G#m/Abm  | A#dim/Bbdim    |
+-------------+-----------+---------+----------+-----------+----------+---------+----------+----------------+
